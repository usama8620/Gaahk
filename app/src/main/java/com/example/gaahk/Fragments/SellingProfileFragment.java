...
public class SellingProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_selling_profile, container, false);


        mRecyclerView1 = rootView.findViewById(R.id.selling_profile_card_recycler);
