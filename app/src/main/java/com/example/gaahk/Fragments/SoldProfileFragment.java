...
public class SoldProfileFragment extends Fragment {

    private ImageAdapter adapter;
    private RecyclerView mRecyclerView1;
    private SlimAdapter mSlimAdapter1;

    public SoldProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_old_profile, container, false);


        mRecyclerView1 = rootView.findViewById(R.id.sold_profile_card_recycler);
...
//        mRecyclerView1.setLayoutManager(layoutManager1);
        ...
        mSlimAdapter1 = SlimAdapter.create()
                .register(R.layout.product_card_view, new SlimInjector<Data>() {
                    @Override
                    public void onInject(final Data data, IViewInjector injector) {
                        injector.clicked(R.id.product_image, new View.OnClickListener() {
                            @Override
